    ...
    const DEFAULT_LINEAR_SOLVER = IterativeSolversJL_GMRES
    """
    ...
    """
    function solve!(problem::AbstractStructuralAnalysis, solver::Union{AbstractSolver,Nothing}=nothing, linear_solve::SciMLBase.AbstractLinearAlgorithm=DEFAULT_LINEAR_SOLVER())
