...
export AbstractConvergenceCriterion, ResidualForceCriterion, ΔUCriterion,
	...
	AbstractSolution, iterations, update!, next!, LinearSolveDefault
...
"Default solver for the linear system solved. It uses defualt LienarSolve.jl solver"
struct LinearSolveDefault <: AbstractSolver end
...
"""
function solve!(problem::AbstractStructuralAnalysis, solver::AbstractSolver = LinearSolveDefault())
