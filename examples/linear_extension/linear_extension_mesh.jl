...
function create_mesh(
    ...
    gmsh.model.addPhysicalGroup(dim_surface, [bottom_surface_index, top_surface_index], fixed_uy_surfaces_index)
    fixed_uz_surfaces_index = 3
    gmsh.model.addPhysicalGroup(dim_surface, [front_surface_index, back_surface_index], fixed_uz_surfaces_index)
    ...
    gmsh.model.setPhysicalName(dim_surface, fixed_ux_surfaces_index, "_$(face_label)_$(ux_bc_label)")
    gmsh.model.setPhysicalName(dim_surface, fixed_uy_surfaces_index, "_$(face_label)_$(uj_bc_label)")
    gmsh.model.setPhysicalName(dim_surface, fixed_uz_surfaces_index, "_$(face_label)_$(uk_bc_label)")
